...
void RussellCrowe::init(const BotInitialData &initialData, BotAttributes &attrib)
{
...
void RussellCrowe::update(const BotInput &input, BotOutput27 &output)
{
...
void RussellCrowe::result(bool won)
{
}

void RussellCrowe::bulletResult(bool hit)
{
